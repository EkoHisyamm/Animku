...
public class ViewTerpopulerAdapter extends RecyclerView.Adapter<ViewTerpopulerAdapter.TerpopulerHolder>{
    ...
    public ViewTerpopulerAdapter(Context mContext, List<AnimeModel> dataList, ArrayList<TerbaruModel> terbaruModels) {
    ...
    @NonNull
    @Override
    public TerpopulerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        viewku = layoutInflater.inflate(R.layout.view_all, parent, false);
        return new TerpopulerHolder(viewku);
    }

    @Override
    public void onBindViewHolder(@NonNull final TerpopulerHolder holder, final int position) {
    ...
    public class TerpopulerHolder extends RecyclerView.ViewHolder{
        private TextView tvJudul, tvEpisode, tvType;
        CardView cvAnimeBaru;
        ImageView ivFoto;

        TerpopulerHolder(View itemView) {
            super(itemView);
